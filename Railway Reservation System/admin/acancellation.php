    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-primary" >
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div class="navbar-nav">
                ...
                <a class="nav-item nav-link" href="acancellation.php" style="font-weight: bold">Cancellation</a>
          ...
          <br>
            ...
            <div class="form-group row">
              <div class="col-sm-10">
                ...
                <button  type="submit" onclick="window.open('adminhomepage.php')"; class="btn btn-dark  btn-lg" class="nav-item nav-link" style="float: right; margin-right: 60px;">BACK</button>
              </div>
            </div>
