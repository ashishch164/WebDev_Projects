          ...
          <br>
            ...
            <div class="form-group row">
              <div class="col-sm-10">
                ...
                <!-- ADD</button> -->
                <input type="submit" onclick="window.open('adeleteTrain.php');"class="btn btn-dark  btn-lg" style="float: right; margin-right: 60px;" name="deletet" value="DELETE">
                <!-- DELETE</button> -->
                <br> <br> 
                &nbsp;&nbsp;
                ...
                <br
                 > 
                <button type="submit" onclick="window.open('amaintain2.php');"class="btn btn-danger btn-lg" style="float: left; margin-left: 165px;">UPDATE OLD TRAIN</button>
                <br> <br> <br>
                 <button  type="submit" onclick="window.open('adminhomepage.php');"class="btn btn-dark  btn-lg" style="float: left; margin-left: 215px;">BACK</button>
              </div>
            </div>
