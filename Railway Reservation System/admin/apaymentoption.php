            ...
            <div class="book-ticket-container">
                <div class="paymentCont">
                                ...
                                <div class="paymentWrap">
                                    <div class="btn-group paymentBtnGroup btn-group-justified" data-toggle="buttons">
                                        <label class="btn paymentMethod active">
                                            <div onclick="window.open('apayment1.php');"class="method visa"></div>
                                            <input type="radio" name="options" checked> 
                                        </label>
                                       <br>
                                        <label class="btn paymentMethod">
                                            <div onclick="window.open('apayment2.php');"class="method UPI"></div>
                                ...
                                <div class="footerNavWrap clearfix">
                                    <button type="submit"onclick="window.open('abooking.php');" class="btn btn-dark  btn-lg" style=" margin-left: 50px;">BACK</button>
