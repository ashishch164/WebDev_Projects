      ...
      <div class="form-group row">
        ...
        <div class="col-sm-8">
          <output type="date" class="form-control" id="date" name="sc"><?php echo $edi12;?></output>
                ...
                <div class="form-group row">
                <label for="inputEmail" class="col-sm-3 col-form-label">SEAT TYPE </label>
                <div class="col-sm-8">
              ...
              <div class="form-group row">
                <div class="col-sm-10">
                  ...
                  &nbsp;
               &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   
               <button type="submit" onclick="window.open('abooking.php');"class="btn btn-dark  btn-lg" sstyle="float: right; margin-right: 50px;">BACK</button>
    ...
    {     if($edi2<=$edi4)
         {
          ...
          {  if($edi3==$row[1])
             ...
             <tr>
              <td><button type="submit"   style="float: left; margin-left: 270px;" ><a href="apaymentoption.php?eid=<?php echo $edi6;?>">MAKE PAYMENT</a></button></td>
              </tr>
<?php
              }
          }
