            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown"style="font-weight: bold" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                     Profile
                  </a>
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="achangepassword.php" style="font-weight: bold">Change password</a>
        ...
        if($newpass==$confirmpass)
          {  
           // if($newpass<9999999)
             ...
             $i=mysqli_query($con,"update admin set password=$newpass where username='$username'" );
