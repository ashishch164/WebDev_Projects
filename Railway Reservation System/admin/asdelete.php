              ...
              <div class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="asdelete.php" style="font-weight: bold">Delete staff</a>
...
<form action="" method="post">
     ...
     <div class="body-container">
        <div class="book-ticket-container" style="height: 40vh">
          <h1 style="font-size: 45px;text-align: center;padding: 0;margin: 0; ">DELETE STAFF</h1>
          <br>
