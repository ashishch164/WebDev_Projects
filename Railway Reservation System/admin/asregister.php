              ...
              <div class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="asregister.php" style="font-weight: bold">Add staff</a>
...
<div class="body-container">
  <div class="book-ticket-container">
    <h1 style="font-size: 45px;text-align: center;padding: 0;margin: 0;">ADD STAFF</h1> <br>
...
{ 
  ...
  { if($cno<999999999||$cno>9999999999)
  {
   ...
   if($z==0)
   {
    $i=mysqli_query($con,"insert into staff(name,username,contactno,dob,emailid,address,password) values('$name','$username',$cno,'$dob','$email','$add','$pass1')");
