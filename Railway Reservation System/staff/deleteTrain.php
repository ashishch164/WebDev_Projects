    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-primary" >
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            ...
            <a class="nav-item nav-link" href="maintain1.php"style="font-weight: bold;">Maintain Train Details</a>
     ...
     <br>
      <div class="form-group row">
        <div class="col-sm-10">
          ...
          <button type="submit" onclick="window.open('maintain1.php');"class="btn btn-dark  btn-lg" style="float: right; margin-right: 50px;">BACK</button>
        </div>
      </div>
