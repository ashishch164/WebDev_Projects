...
<div class="body-container">
  <div class="book-ticket-container">
    <h1 style="font-size: 45px;text-align: center;padding: 0;margin: 0;">REGISTER</h1> <br>
    ...
    <br>
      ...
      <div class="form-group row">
        <div class="col-sm-10">
            <br>
          <input  type="submit" class="btn btn-danger btn-lg" style="float: left; margin-left: 220px;" name="register" value="REGISTER">
