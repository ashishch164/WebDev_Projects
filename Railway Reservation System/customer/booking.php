        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-primary" >
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div class="navbar-nav">
                ...
                <a class="nav-item nav-link" href="#" style="font-weight: bold;">Book Tickets</a>
              ...
              <div class="form-group row">
                <div class="col-sm-10">
                  ...
                  <br>
                     <br>
                        <br>
                   <input type="submit" class="btn btn-dark btn-lg" style="float: left; margin-left: 185px;" onclick="window.open('VTdetail.php');" name="view" value="VIEW TRAIN DETAILS">
                  <br>
<br>
<br>
