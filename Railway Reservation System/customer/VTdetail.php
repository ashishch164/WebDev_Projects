     ...
     <br>
      <div class="form-group row">
        <div class="col-sm-10">
          ...
          <button type="submit" onclick="window.open('homepage.php');"class="btn btn-dark  btn-lg" style="float: right; margin-right: 50px;">BACK</button>
        </div>
      </div>
...
?>
    ...
    <button><a href="t.php?eid=<?php echo $_SESSION['source'];?>&eid2=<?php echo $_SESSION['destination'];?>">View</a></button>
