  ...
  else
  {
   ...
   <!--    <script type="text/javascript">
      $(window).on('load',function(){
          setTimeout(function(){ alert(" Login succesfully"); }, 700); 
      });
  </script>-->
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-primary" >
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div class="navbar-nav">
                <a class="nav-item nav-link active" href="#"style="font-weight: bold">Home <span class="sr-only">(current)</span></a>
          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="d-block w-100" src="Passenger-train-at-Jalgaon-Junction-railway-station.jpg"height="503px" width="1400px" alt="First slide">
              </div>
              <div class="carousel-item">
                <img class="d-block w-100" src="wp5522042.jpg" height="503px" width="1400px"alt="Second slide">
              </div>
              <div class="carousel-item">
